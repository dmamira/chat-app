                    ...
                    if (!docData.image) {
                        if (user.displayName == docData.name) {
                            rows.push(<Chat message={docData.message} createOn={docData.creatOn}
                                            isMine={true} key={docData.creatOn.nanoseconds.toString()} icon={docData.icon}/>)
                        } else {
                            rows.push(<Chat message={docData.message} name={docData.name} createOn={docData.creatOn}
                                            isMine={false} key={docData.creatOn.nanoseconds.toString()} icon={docData.icon}/>)
                        }
                    } else {
                        rows.push(<Image url={docData.image} createOn={docData.creatOn} name={docData.name}
                                         ...
                                         key={docData.creatOn.nanoseconds.toString()} icon={docData.icon}/>);
                    }
